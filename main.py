...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="#F5F5F5", relief=RAISED, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI", bg="#F5F5F5", fg="#00203F", font=("Lato", 25, "bold")).place(x=110, y=10)

        self.btn_1 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(1), state=DISABLED)
        self.btn_1.place(x=20,y=100)
        self.btn_2 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(2), state=DISABLED)
        self.btn_2.place(x=190,y=100)
        self.btn_3 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(3), state=DISABLED)
        self.btn_3.place(x=360,y=100)

        self.btn_4 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(4), state=DISABLED)
        self.btn_4.place(x=20,y=200)
        self.btn_5 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(5), state=DISABLED)
        self.btn_5.place(x=190,y=200)
        self.btn_6 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(6), state=DISABLED)
        self.btn_6.place(x=360,y=200)

        self.btn_7 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(7), state=DISABLED)
        self.btn_7.place(x=20,y=300)
        self.btn_8 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(8), state=DISABLED)
        self.btn_8.place(x=190,y=300)
        self.btn_9 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#A9A9A9", activebackground="#A9A9A9", bd=3, command=lambda: self.__human_play(9), state=DISABLED)
        ...
        self.machine_first_control = Button(self.make_canvas, text="AI vs Human", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=50, y=380)

        self.human_first_control = Button(self.make_canvas, text="Human vs AI", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=260, y=380)
    ...
    def machine_line_match(self):
        ...
        if self.activate_btn[1-1]['text'] == self.activate_btn[2-1]['text'] == self.activate_btn[3-1]['text'] == "X":
            ...
            found=1
        if found == 1:
            messagebox.showinfo("Game Over", "AI is winner")
...
if __name__ == "__main__":
    window = Tk()
    window.title("AI Tic-Tac-Toe - CS Project")
